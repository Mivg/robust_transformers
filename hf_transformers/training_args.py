...
# In particular, fixed imports only, because the version in transformers release 4.0.1 misses some important flags needed such
# as ignore_data_skip and model_parallel
...
from transformers import is_torch_available, is_torch_tpu_available, EvaluationStrategy
